...
contract DateTime {
    ...
    function getEntire(uint256 timestamp)
        public
        pure
        returns (
            uint16,
    ...
    {
        return (
            parseTimestamp(timestamp).year,
            parseTimestamp(timestamp).month,
            parseTimestamp(timestamp).day,
            parseTimestamp(timestamp).hour,
            parseTimestamp(timestamp).minute,
            parseTimestamp(timestamp).second,
            parseTimestamp(timestamp).weekday
        );
    }
